...
document.getElementById("contactForm").addEventListener("submit", function (event) {
    ...
    const assunto = "Landing Page Carolina";
...
function sendMessage() {
    ...
    const textWpp = encodeURIComponent("Olá, acessei a landing page de Carolina-MA e gostaria de informações sobre os pacotes.");
    ...
    const assunto = "Landing Page Carolina";
    const mensagem = "Lead clicou no botão do WhatsApp através da landing page Carolina-MA.";
    const client = "dhagesturismo"; // Valor fixo ou variável de identificação do cliente
